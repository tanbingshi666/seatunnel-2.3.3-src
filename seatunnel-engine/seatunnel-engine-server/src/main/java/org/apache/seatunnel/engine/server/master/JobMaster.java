...
public class JobMaster {
    ...
    public void init(long initializationTimestamp, boolean restart, boolean canRestoreAgain)
        ...
        // Job fake_to_console.conf (781799696262758401) needed jar urls
        // [file:/D:/project/bigdata/source-code/seatunnel/seatunnel-connectors-v2/connector-console/target/classes/]
        LOGGER.info(
                String.format(
        ...
        // 4 LogicDag 转换为 ExecutionPlan
        // 5 ExecutionPlan 转换为 PhysicalPlan
    ...
    public void run() {
        try {
            if (!restore) {
                ...
                // Job Job fake_to_console.conf (781799696262758401) waiting for scheduler finished
                LOGGER.info(
                        String.format(
